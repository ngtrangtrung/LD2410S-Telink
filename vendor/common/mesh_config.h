...
#define LIGHT_TYPE_NONE				0x0000
#define LIGHT_TYPE_CT				0x0001
#define LIGHT_TYPE_HSL				0x0002
#define LIGHT_TYPE_XYL				0x0003
#define LIGHT_TYPE_POWER			0x0004
#define LIGHT_TYPE_CT_HSL			0x0005
#define LIGHT_TYPE_DIM			    0x0006   // only single PWM
#define LIGHT_TYPE_PANEL			0x0007   // only ONOFF model
#define LIGHT_TYPE_LPN_ONOFF_LEVEL  0x0008   // only ONOFF , LEVEL model
// Additional Device
...
#define LIGHT_TYPE_SEL				LIGHT_TYPE_PANEL
		...
		#ifndef LIGHT_TYPE_SEL
			#define LIGHT_TYPE_SEL	LIGHT_TYPE_NONE
		#endif
	#endif
#endif

#if (LIGHT_TYPE_SEL == LIGHT_TYPE_CT) || (LIGHT_TYPE_SEL == LIGHT_TYPE_CT_HSL) || (LIGHT_TYPE_SEL == LIGHT_TYPE_PANEL)
#define LIGHT_TYPE_CT_EN            1
#else
#define LIGHT_TYPE_CT_EN            0
#endif

#if (LIGHT_TYPE_SEL == LIGHT_TYPE_HSL) || (LIGHT_TYPE_SEL == LIGHT_TYPE_CT_HSL) || (LIGHT_TYPE_SEL == LIGHT_TYPE_PANEL)
...
#else
	#if ((MESH_USER_DEFINE_MODE == MESH_MI_ENABLE) || __PROJECT_MESH_LPN__ || SPIRIT_PRIVATE_LPN_EN)
...
#define MD_VENDOR_2ND_EN            (DEBUG_VENDOR_CMD_EN && MI_API_ENABLE)
	#endif
#else                           // light node
    #if (LIGHT_TYPE_SEL == LIGHT_TYPE_LPN_ONOFF_LEVEL)
