...
#define MESH_PERIODIC_PUBLISH_RANDOM_TIME	300000  // 5 minutes
#define MESH_PERIODIC_PUBLISH_TIME	        900000  // 15 minutes

/*
#define MESH_PERIODIC_PUBLISH_RANDOM_TIME	1000  // 5 minutes
#define MESH_PERIODIC_PUBLISH_TIME	        1000  // 15 minutes
*/
...
// User define
typedef void (*typeCommon_HandleTxMessageFunc)(u8*, int);
