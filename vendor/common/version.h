...
#define FW_VERSION_TELINK_RELEASE   (VERSION_GET(0x31, 0x33))       // user can't modify
...
#define LM_TWO_IN_TWO_OUT_MD     0x0090
#define LM_TWO_IN_ONE_OUT_HP_MD  0x0091

#if LIGHT_TYPE_SEL == LIGHT_TYPE_PANEL
    #if !_HP_RELAY_
    #define MESH_PID_SEL     LM_TWO_IN_TWO_OUT_MD
    #else
	#define MESH_PID_SEL     LM_TWO_IN_ONE_OUT_HP_MD
    #endif
#endif
