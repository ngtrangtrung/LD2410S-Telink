...
#define HSL_SAT_DEFAULT   		(HSL_SAT_MIN)
...
#define US_DELAY_TIME_TO_SAVE_LIGHT_STATE    2000000       // 2 s
...
extern u8 ct_flag;
extern u32 control_output_start_t_ms[LIGHT_CNT];
...
#define LGT_CMD_WAIT_CONFIRM_RST        0xcd
...
void light_state_refresh(int idx);
